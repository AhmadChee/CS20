...
Purpose: Create a TimeConverter application that allows the user to choose among converting hours to minutes, days to hours, minutes to hours, or hours to days. Use methods as apprpriate. 
...
public class TimeConverter 
{
	public static void hoursTominutes()
	{
		...
		mTime =  (hTemp * 60);//formula of conversion between hours to minutes
